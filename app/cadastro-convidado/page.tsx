...
const founderBenefits = [
  "Cadastro gratuito para terapeutas previamente convidados",
  "Perfil profissional próprio no AuraMeets",
  "Cadastro de serviços e ofertas especiais",
  "Divulgação dentro da plataforma",
...
export default function CadastroFundadorPage() {
  ...
  useEffect(() => {
    function verificarPrazo() {
      setPrazoEncerrado(new Date() >= DEADLINE);
    }

    verificarPrazo();

    const timer = window.setInterval(verificarPrazo, 30000);
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (new Date() >= DEADLINE) {
      ...
      setErro(
        "O período especial de cadastro gratuito foi encerrado. O cadastro profissional agora é de R$ 35,00 por mês.",
      );
      return;
    }
  ...
  if (prazoEncerrado && !sucesso) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#050816] px-4 py-10 text-white sm:px-6 lg:px-8">
        <section className="w-full max-w-2xl rounded-3xl border border-purple-400/40 bg-[#111A33] p-6 text-center shadow-2xl sm:p-8 md:p-12">
          ...
          <h1 className="mt-5 text-3xl font-black leading-tight sm:text-4xl md:text-5xl">
            O período especial de cadastro gratuito foi encerrado.
          </h1>

          <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg">
            A partir de agora, novos terapeutas entram pelo Perfil Profissional
            AuraMeets por R$ 35,00 por mês, sem fidelidade.
          </p>

          <Link
            href="/cadastro-fundador"
            className="mt-8 inline-flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 px-8 py-4 font-black text-white transition hover:brightness-110 sm:w-auto"
          >
            IR PARA O CADASTRO PROFISSIONAL
          </Link>
        </section>
      </main>
    );
      ...
      <main className="flex min-h-screen items-center justify-center bg-[#050816] px-4 py-10 text-white sm:px-6 lg:px-8">
        <section className="w-full max-w-2xl rounded-3xl border border-yellow-400/40 bg-[#111A33] p-6 text-center shadow-2xl sm:p-8 md:p-12">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">
            Seu cadastro profissional gratuito foi concluído dentro do prazo especial. Agora você poderá acessar sua conta e completar seu perfil.
          </p>

          <div className="mt-8 rounded-2xl border border-slate-700 bg-[#080D22] p-5 text-left sm:p-6">
            <p className="font-bold text-yellow-400">
              Convite especial confirmado
            </p>
            ...
            <p className="mt-2 leading-7 text-slate-300">
              Seu cadastro foi realizado gratuitamente por este convite especial. A mensalidade de R$ 17,00 passa a ser cobrada a partir de 01/09/2026.
            </p>
          </div>
      ...
      <div className="mx-auto grid w-full max-w-[1500px] gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-10 xl:grid-cols-[0.85fr_1.35fr] xl:gap-14">
        <section className="lg:sticky lg:top-8 lg:self-start xl:top-12">
          ...
          <p className="mt-8 text-xs font-bold uppercase tracking-[0.25em] text-yellow-400 sm:mt-10 sm:text-sm sm:tracking-[0.35em] lg:mt-12">
            Convite especial AuraMeets
          </p>

          <h1 className="mt-5 max-w-2xl text-4xl font-black leading-[1.05] sm:text-5xl lg:text-5xl xl:text-6xl">
            Seu convite gratuito está reservado até segunda-feira às 10:00.
          </h1>

          <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">
            Este link é exclusivo para terapeutas que já haviam sido convidados.
            O cadastro permanece gratuito somente até 17/08/2026, às 10:00
            (horário de Brasília).
          </p>
          ...
          <div className="mt-8 rounded-3xl border border-yellow-300/50 bg-yellow-400 p-6 text-black shadow-[0_20px_80px_rgba(250,204,21,0.12)] sm:p-8 lg:mt-10">
            ...
            <p className="mt-4 text-base font-bold leading-7 sm:text-lg">
              O cadastro é gratuito até o prazo deste convite. A partir de 01/09/2026, será cobrada mensalidade de R$ 17,00.
            </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-800 bg-[#0B1125] p-4">
              <p className="text-2xl font-black text-yellow-400">17/08</p>
        ...
        <section className="min-w-0 rounded-3xl border border-slate-800 bg-[#111A33] p-5 shadow-2xl sm:p-8 lg:p-9 xl:p-12">
          ...
          <h2 className="mt-4 text-3xl font-black leading-tight sm:text-4xl">
            Conclua seu cadastro gratuito
          </h2>

          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300 sm:text-base">
            Preencha seus dados abaixo. Este acesso gratuito é temporário e exclusivo
            para profissionais convidados antes do encerramento da fase de testes.
          </p>

          <div className="mt-6 rounded-2xl border border-yellow-400/50 bg-yellow-400/10 p-5">
            <p className="text-sm font-black uppercase tracking-[0.16em] text-yellow-300">
              Cadastro gratuito somente até segunda-feira, 17/08, às 10:00
            </p>
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Após esse horário, este link será encerrado automaticamente e o
              cadastro profissional seguirá pelo plano de R$ 35,00 por mês.
            </p>

            <p className="mt-3 text-sm font-bold leading-6 text-yellow-200">
              Importante: para quem concluir o cadastro por este convite, a mensalidade
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6 sm:mt-10">
            ...
            >
              ...
              <span className="text-sm leading-6 text-slate-300">
                ...
                e a política de privacidade do AuraMeets e estou ciente de que,
                para este convite especial, a mensalidade de R$ 17,00 será cobrada
